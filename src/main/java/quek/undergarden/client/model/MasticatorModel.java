...
public class MasticatorModel<T extends MasticatorEntity> extends ListModel<T> {
	...
	private final ModelPart innerupperjaw;
	private final ModelPart innerlowerjaw;
	private final ModelPart leftarm;
	private final ModelPart lowerarm2;
	private final ModelPart frontfingers2;
	private final ModelPart backfinger2;
	private final ModelPart rightarm;
	private final ModelPart lowerarm;
	private final ModelPart frontfingers;
	private final ModelPart backfinger;
	...
	public MasticatorModel() {
		...
		innerupperjaw = new ModelPart(this);
		...
		innerlowerjaw = new ModelPart(this);
		...
		frontfingers2 = new ModelPart(this);
		...
		backfinger2 = new ModelPart(this);
		...
		frontfingers = new ModelPart(this);
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		float flap = Mth.sin((entity.tickCount) * 0.3F) * 0.3F;
