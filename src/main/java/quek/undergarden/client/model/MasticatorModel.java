...
public class MasticatorModel<T extends MasticatorEntity> extends ListModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("undergarden", "masticator"), "main");
	//private final ModelPart masticator;
	...
	public MasticatorModel(ModelPart root) {
		//this.masticator = root.getChild("masticator");
	...
	public static LayerDefinition createBodyLayer() {
		...
		//PartDefinition masticator = partdefinition.addOrReplaceChild("masticator", CubeListBuilder.create(), PartPose.offset(0.0F, -21.0F, -10.0F));
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(70, 46).addBox(7.0F, -6.0F, -4.0F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(51, 83).addBox(-7.0F, -6.0F, -4.0F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, 1.0F));
		...
		PartDefinition leftArm = partdefinition.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(0, 79).addBox(-1.0F, -9.0F, -10.0F, 16.0F, 19.0F, 19.0F, new CubeDeformation(0.0F))
				.texOffs(37, 141).addBox(0.0F, 9.8177F, -2.0838F, 14.0F, 17.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(16.0F, -8.0F, 17.0F, 0.1745F, 0.0F, 0.0F));
		...
		PartDefinition rightArm = partdefinition.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(51, 103).addBox(-15.0F, -9.0F, -10.0F, 16.0F, 19.0F, 19.0F, new CubeDeformation(0.0F))
				.texOffs(79, 141).addBox(-14.0F, 9.8177F, -2.0838F, 14.0F, 17.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-16.0F, -8.0F, 17.0F, 0.1745F, 0.0F, 0.0F));
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(75, 75).addBox(-14.0F, -6.0F, -18.0F, 28.0F, 15.0F, 13.0F, new CubeDeformation(0.0F))
				.texOffs(0, 51).addBox(-13.0F, 7.0F, -7.0F, 26.0F, 10.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.0F, 20.0F));
