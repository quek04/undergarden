...
public class DenizenEyesLayer<T extends Denizen, M extends EntityModel<T>> extends RenderLayer<T, M> {
	private static final RenderType DENIZEN_EYES = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(Undergarden.MODID, "textures/entity/denizen_eyes.png"));
	private static final RenderType DENIZEN2_EYES = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(Undergarden.MODID, "textures/entity/denizen2_eyes.png"));;
	...
	public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight, T entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.getParentModel().renderToBuffer(poseStack, consumer, 1, 1);
	}
}