...
public class RogdoricGrongletEntityRenderer extends ThrownItemRenderer<RogdoricGronglet> {

	private final ItemRenderer itemRenderer;

	public RogdoricGrongletEntityRenderer(EntityRendererProvider.Context context) {
		super(context, 0.0F, true);
		this.itemRenderer = context.getItemRenderer();
	}

	@Override
	public void render(RogdoricGronglet entity, float yaw, float partialTicks, PoseStack stack, MultiBufferSource bufferSource, int light) {
