...
public class RotlingRender extends MobRenderer<RotlingEntity, RotlingModel<RotlingEntity>> {
    ...
    private static final ResourceLocation texture = new ResourceLocation(UndergardenMod.MODID, "textures/entities/rotling.png");
    private static final ResourceLocation otherside_texture = new ResourceLocation(UndergardenMod.MODID, "textures/entities/rotling_otherside.png");
