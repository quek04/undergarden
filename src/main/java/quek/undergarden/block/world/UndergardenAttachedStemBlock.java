...
public class UndergardenAttachedStemBlock extends AttachedStemBlock {
    ...
    public UndergardenAttachedStemBlock(StemGrownBlock stemGrownBlock) {
    ...
    public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
        return facingState.getBlock() != this.grownFruit && facing == stateIn.get(FACING) ? this.grownFruit.getStem().getDefaultState().with(UndergardenStemBlock.AGE, 7) : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
    }
    ...
    public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
        return new ItemStack(UndergardenItems.gloomgourd_seeds.get());
    }
