...
public class Minion extends AbstractGolem implements RangedAttackMob {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Mob.class, 10, true, false, (entity) ->
				!(entity.getType() == UGEntityTypes.STONEBORN_VAGRANT.get()) && entity instanceof Enemy || entity.getType().is(UGTags.Entities.ROTSPAWN) || entity.getType().is(UGTags.Entities.CAVERN_CREATURE))
		);
	}
