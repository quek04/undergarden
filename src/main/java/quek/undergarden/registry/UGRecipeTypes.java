...
public class UGRecipeTypes {
	...
	public static final DeferredHolder<RecipeType<?>, RecipeType<ArmorInfusingRecipe>> ARMOR_INFUSING = RECIPE_TYPES.register("armor_infusing", () -> RecipeType.simple(ResourceLocation.fromNamespaceAndPath(Undergarden.MODID, "armor_infusing")));
}
