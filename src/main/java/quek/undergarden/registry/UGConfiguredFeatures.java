...
public class UGConfiguredFeatures {
    ...
    public static final ConfiguredFeature<RandomPatchConfiguration, ?> INK_MUSHROOM_PATCH = register("ink_mushroom_patch", Feature.RANDOM_PATCH.configured(patch(UGBlocks.INK_MUSHROOM.get(), 64)));
    public static final ConfiguredFeature<RandomPatchConfiguration, ?> BLOOD_MUSHROOM_PATCH = register("blood_mushroom_patch", Feature.RANDOM_PATCH.configured(patch(UGBlocks.BLOOD_MUSHROOM.get(), 64)));
