...
public class UGEntityTypes {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<GreaterDweller>> GREATER_DWELLER = ENTITIES.register("greater_dweller", () -> EntityType.Builder.of(GreaterDweller::new, MobCategory.CREATURE).sized(2.5F, 3.0F).eyeHeight(2.1F).build("greater_dweller"));
