...
public class UGEntityTypes {
    ...
    public static final EntityType<StonebornEntity> STONEBORN_TYPE = EntityType.Builder.create(StonebornEntity::new, EntityClassification.MONSTER)
            .size(1.0F, 2.6F).build("stoneborn");
    ...
    public static final EntityType<GwibEntity> GWIB_TYPE = EntityType.Builder.create(GwibEntity::new, EntityClassification.WATER_CREATURE)
            .size(1.5F, 1.5F).build("gwib");
