...
public class UGEntityTypes {
	...
	//normal
	public static final DeferredHolder<EntityType<?>, EntityType<Rotling>> ROTLING = registerWithEgg("rotling", EntityType.Builder.of(Rotling::new, MobCategory.MONSTER).notInPeaceful().sized(0.6F, 1.0F), Rotling::registerAttributes, RotspawnMonster::canRotspawnSpawn);
	public static final DeferredHolder<EntityType<?>, EntityType<Rotwalker>> ROTWALKER = registerWithEgg("rotwalker", EntityType.Builder.of(Rotwalker::new, MobCategory.MONSTER).notInPeaceful().sized(0.8F, 2.5F), Rotwalker::registerAttributes, RotspawnMonster::canRotspawnSpawn);
	public static final DeferredHolder<EntityType<?>, EntityType<Rotbeast>> ROTBEAST = registerWithEgg("rotbeast", EntityType.Builder.of(Rotbeast::new, MobCategory.MONSTER).notInPeaceful().sized(1.5F, 3.0F), Rotbeast::registerAttributes, RotspawnMonster::canRotspawnSpawn);
	public static final DeferredHolder<EntityType<?>, EntityType<Rotbelcher>> ROTBELCHER = registerWithEgg("rotbelcher", EntityType.Builder.of(Rotbelcher::new, MobCategory.MONSTER).notInPeaceful().sized(0.8F, 2.5F), Rotbelcher::registerAttributes, RotspawnMonster::canRotspawnSpawn);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<Nargoyle>> NARGOYLE = registerWithEgg("nargoyle", EntityType.Builder.of(Nargoyle::new, MobCategory.MONSTER).notInPeaceful().sized(1.0F, 1.5F), Nargoyle::registerAttributes, CavernMonster::canCreatureSpawn);
	public static final DeferredHolder<EntityType<?>, EntityType<Muncher>> MUNCHER = registerWithEgg("muncher", EntityType.Builder.of(Muncher::new, MobCategory.MONSTER).notInPeaceful().sized(0.8F, 0.8F), Muncher::registerAttributes, CavernMonster::canCreatureSpawn);
	public static final DeferredHolder<EntityType<?>, EntityType<Sploogie>> SPLOOGIE = registerWithEgg("sploogie", EntityType.Builder.of(Sploogie::new, MobCategory.MONSTER).notInPeaceful().sized(0.8F, 0.8F).eyeHeight(0.3F), Sploogie::registerAttributes, CavernMonster::canCreatureSpawn);
	public static final DeferredHolder<EntityType<?>, EntityType<Gwib>> GWIB = registerWithEgg("gwib", EntityType.Builder.of(Gwib::new, MobCategory.WATER_CREATURE).notInPeaceful().sized(1.0F, 0.5F).eyeHeight(0.25F), Gwib::registerAttributes, Gwib::canGwibSpawn);
