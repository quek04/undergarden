...
public class UndergardenBiomeFeatures {
    ...
    public static final UndergardenTreeFeatureConfig SMOGSTEM_TREE_CONFIG = (new UndergardenTreeFeatureConfig.Builder(new SimpleBlockStateProvider(SMOGSTEM_LOG), new SimpleBlockStateProvider(SMOGSTEM_LEAVES))).build();
    public static final UndergardenTreeFeatureConfig WIGGLEWOOD_TREE_CONFIG = (new UndergardenTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WIGGLEWOOD_LOG), new SimpleBlockStateProvider(WIGGLEWOOD_LEAVES))).build();
    ...
    public static final LiquidsConfig ENCLOSED_WATER_SPRING = new LiquidsConfig(Fluids.WATER.getDefaultState(), true, 5, 0, ImmutableSet.of(UndergardenBlocks.depthrock.get()));
    ...
    public static void addBeanBushes(Biome biomeIn) {
    ...
    public static void addTrees(Biome biomeIn) {
        biomeIn.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, UndergardenWorldGen.SMOGSTEM_TREE.get().withConfiguration(SMOGSTEM_TREE_CONFIG).withPlacement(Placement.COUNT_CHANCE_HEIGHTMAP_DOUBLE.configure(new HeightWithChanceConfig(10, 5))));
    }
}
