...
public class UGWoodStuff {
	...
	public static final BlockSetType ANCIENT_ROOT_WOOD_SET = new BlockSetType(new ResourceLocation(Undergarden.MODID, "ancient_root").toString());
	...
	public static final WoodType ANCIENT_ROOT_WOOD_TYPE = WoodType.register(new WoodType(new ResourceLocation(Undergarden.MODID, "ancient_root").toString(), ANCIENT_ROOT_WOOD_SET));
}
