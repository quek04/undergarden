...
public enum UndergardenArmorMaterials implements IArmorMaterial {
    ...
    FROSTSTEEL("froststeel", 20, new int[]{2, 5, 6, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 4, () -> Ingredient.fromItems(UndergardenItems.froststeel_ingot.get())),
    UTHERIC("utheric", 36, new int[]{3, 6, 8, 3}, 13, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3, () -> Ingredient.fromItems(UndergardenItems.utherium_ingot.get())),
    MASTICATED("masticated", 17, new int[]{6, 6, 6, 6}, 5, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0, () -> Ingredient.fromItems(UndergardenItems.masticator_scales.get()))
    ;
