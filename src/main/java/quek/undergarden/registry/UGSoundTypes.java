...
public class UGSoundTypes {
	...
	public static final SoundType ANCIENT_ROOT = new DeferredSoundType(1.0F, 0.5F, () -> SoundEvents.WOOD_BREAK, () -> SoundEvents.WOOD_STEP, () -> SoundEvents.WOOD_PLACE, () -> SoundEvents.WOOD_HIT, () -> SoundEvents.WOOD_FALL);
