...
public class UGItems {
	...
	public static final DeferredItem<Item> UTHERIC_GRONGLET = register("utheric_gronglet", properties -> new GrongletItem(UGBlocks.UTHERIC_GRONGLET.get(), properties), () -> new Item.Properties().useBlockDescriptionPrefix().food(UGFoods.GRONGLET, UGConsumables.UTHERIC_GRONGLET).component(DataComponents.EQUIPPABLE, grongEquip).component(UGDataComponents.SLINGSHOT_AMMO.get(), UGSlingshotAmmoSettings.GRONGLET.apply("utheric_")));
