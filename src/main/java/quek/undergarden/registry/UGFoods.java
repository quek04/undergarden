...
public class UGFoods {
    ...
    public static final Food BLOODY = (new Food.Builder())
            .hunger(4)
            .saturation(0.4F)
            .effect(() -> new EffectInstance(Effects.STRENGTH, 600, 0, false, true), 1.0F)
    ...
    public static final Food INKY = (new Food.Builder())
            ...
            .effect(() -> new EffectInstance(Effects.RESISTANCE, 600, 0, false, true), 1.0F)
            .setAlwaysEdible()
            .build();
    public static final Food INDIGO = (new Food.Builder())
            ...
            .effect(() -> new EffectInstance(Effects.SLOWNESS, 600, 0, false, true), 1.0F)
            .setAlwaysEdible()
            .build();
