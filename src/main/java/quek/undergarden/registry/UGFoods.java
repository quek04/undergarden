...
public class UGFoods {
	...
	public static final FoodProperties ROTTEN_BLISTERBERRY = new FoodProperties.Builder().nutrition(3).saturationMod(0.1F).effect(() -> new MobEffectInstance(MobEffects.HUNGER, 600, 0), 1.0F).build();
	...
	public static final FoodProperties BLOOD_GLOBULE = new FoodProperties.Builder().nutrition(0).saturationMod(0.0F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 20, 3, false, true), 1.0F).alwaysEat().build();
