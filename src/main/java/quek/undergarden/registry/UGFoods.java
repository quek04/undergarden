...
public class UGFoods {
	...
	public static final FoodProperties ROGDORIUM = new FoodProperties.Builder().nutrition(0).saturationModifier(0.0F).alwaysEdible().effect(() -> new MobEffectInstance(UGEffects.PURITY, 100, 0, false, true), 0.25F).build();
}