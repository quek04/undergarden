...
public class UGFoods {
    ...
    public static final Food GLOOMGOURD_PIE = (new Food.Builder()).hunger(8).saturation(0.3F).effect(() -> new EffectInstance(UGEffects.virulent_resistance.get(), 60, 0 , false, true), 1.0F).build();
