...
public class UGArmorMaterials {
	...
	public static final ArmorMaterial ANCIENT = new ArmorMaterial(37, makeDefense(2, 5, 6, 2, 11), 15, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, UGTags.Items.REPAIRS_ANCIENT_ARMOR, UGEquipmentAssets.ANCIENT);
