...
public class UGArmorMaterials {
	...
	}), 10, SoundEvents.ARMOR_EQUIP_IRON, () -> Ingredient.of(UGItems.CLOGGRUM_INGOT.get()), List.of(new ArmorMaterial.Layer(new ResourceLocation(Undergarden.MODID, "cloggrum"))), 1.0F, 0.0F)
	);
	...
	}), 15, SoundEvents.ARMOR_EQUIP_GOLD, () -> Ingredient.of(UGItems.FROSTSTEEL_INGOT.get()), List.of(new ArmorMaterial.Layer(new ResourceLocation(Undergarden.MODID, "froststeel"))), 4.0F, 0.05F)
	);
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> UTHERIUM = ARMOR_MATERIALS.register("utherium", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
		...
		map.put(ArmorItem.Type.HELMET, 3);
	}), 13, SoundEvents.ARMOR_EQUIP_DIAMOND, () -> Ingredient.of(UGItems.UTHERIUM_CRYSTAL.get()), List.of(new ArmorMaterial.Layer(new ResourceLocation(Undergarden.MODID, "utherium"))), 3.0F, 0.0F)
	);
