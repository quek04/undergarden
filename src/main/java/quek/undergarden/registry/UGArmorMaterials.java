...
public class UGArmorMaterials {
	...
	}), 10, SoundEvents.ARMOR_EQUIP_IRON, () -> Ingredient.of(UGItems.CLOGGRUM_INGOT.get()), List.of(new ArmorMaterial.Layer(Undergarden.prefix("cloggrum"))), 1.0F, 0.0F)
	);
	...
	}), 15, SoundEvents.ARMOR_EQUIP_GOLD, () -> Ingredient.of(UGItems.FROSTSTEEL_INGOT.get()), List.of(new ArmorMaterial.Layer(Undergarden.prefix("froststeel"))), 4.0F, 0.05F)
	);
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> UTHERIUM = ARMOR_MATERIALS.register("utherium", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
		...
		map.put(ArmorItem.Type.HELMET, 3);
	}), 13, SoundEvents.ARMOR_EQUIP_DIAMOND, () -> Ingredient.of(UGItems.UTHERIUM_CRYSTAL.get()), List.of(new ArmorMaterial.Layer(Undergarden.prefix("utherium"))), 3.0F, 0.0F)
	);
	...
	public static final DeferredHolder<ArmorMaterial, ArmorMaterial> ANCIENT = ARMOR_MATERIALS.register("ancient", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
		...
		map.put(ArmorItem.Type.CHESTPLATE, 6);
		map.put(ArmorItem.Type.HELMET, 2);
		}), 0, SoundEvents.ARMOR_EQUIP_IRON, () -> Ingredient.EMPTY, List.of(new ArmorMaterial.Layer(Undergarden.prefix("ancient"))), 0.0F, 0.0F)
	);
}