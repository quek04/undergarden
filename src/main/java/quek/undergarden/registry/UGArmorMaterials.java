...
public class UGArmorMaterials {
	...
	public static final ArmorMaterial FROSTSTEEL = new ArmorMaterial(40, makeDefense(3, 6, 8, 3, 19), 18, SoundEvents.ARMOR_EQUIP_GOLD, 4.0F, 0.05F, UGTags.Items.REPAIRS_FROSTSTEEL_ARMOR, UGEquipmentAssets.FROSTSTEEL);
