...
public class UGTileEntities {
    ...
    public static final RegistryObject<TileEntityType<ShardTorchTE>> shard_torch_te = TILE_ENTITIES.register("shard_torch_te", () ->
            new TileEntityType<>(ShardTorchTE::new, Sets.newHashSet(UGBlocks.shard_torch.get(), UGBlocks.shard_wall_torch.get()), null));
    public static final RegistryObject<TileEntityType<SmogVentTE>> smog_vent_te = TILE_ENTITIES.register("smog_vent_te", () ->
