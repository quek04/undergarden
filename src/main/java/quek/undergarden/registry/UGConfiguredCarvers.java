...
public class UGConfiguredCarvers {
	...
	public static final ResourceKey<ConfiguredWorldCarver<?>> UNDERGARDEN_DEPTHS_CAVE = ResourceKey.create(Registries.CONFIGURED_CARVER, ResourceLocation.fromNamespaceAndPath(Undergarden.MODID, "undergarden_depths_cave"));
	...
	public static void bootstrap(BootstrapContext<ConfiguredWorldCarver<?>> context) {
		...
		context.register(UNDERGARDEN_DEPTHS_CAVE, UGCarvers.UNDERGARDEN_CAVE.get().configured(
			new CaveCarverConfiguration(
				0.5F,
				UniformHeight.of(VerticalAnchor.aboveBottom(10), VerticalAnchor.absolute(-10)), //y
				ConstantFloat.of(0.5F), //y scale
				VerticalAnchor.absolute(-54), //liquid level
				blocks.getOrThrow(UGTags.Blocks.UNDERGARDEN_DEPTHS_CARVER_REPLACEABLES), //replaceable blocks
				UniformFloat.of(0.7F, 1.4F), //horizontal radius multiplier
				UniformFloat.of(0.8F, 1.3F), //vertical radius multiplier
				UniformFloat.of(-1.0F, -0.4F) //floor level
			)
