...
public class UGConfiguredCarvers {
	...
	public static final ResourceKey<ConfiguredWorldCarver<?>> OTHERSIDE_CAVE = ResourceKey.create(Registries.CONFIGURED_CARVER, ResourceLocation.fromNamespaceAndPath(Undergarden.MODID, "otherside_cave"));
