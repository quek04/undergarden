...
public class UGFeatures {
    ...
    public static void registerConfiguredFeatures() {
        ...
        register("ashen_patch", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(UGBlocks.ashen_tall_deepturf.get().getDefaultState()), new SimpleBlockPlacer())).tries(64).whitelist(ImmutableSet.of(UGBlocks.ashen_deepturf.get())).func_227317_b_().build()).func_242733_d(256).func_242728_a().func_242731_b(100));
        ...
        register("pebble_patch", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(UGBlocks.depthrock_pebbles.get().getDefaultState()), new SimpleBlockPlacer())).tries(32).whitelist(ImmutableSet.of(UGBlocks.deepturf_block.get(), UGBlocks.ashen_deepturf.get(), UGBlocks.depthrock.get(), UGBlocks.shiverstone.get())).func_227317_b_().build()).func_242733_d(256).func_242728_a().func_242731_b(75));
        ...
        register("seagrass_patch", Feature.SIMPLE_BLOCK.withConfiguration(new BlockWithContextConfig(UGBlocks.glowing_sea_grass.get().getDefaultState(), ImmutableList.of(UGBlocks.depthrock.get().getDefaultState(), UGBlocks.deepsoil.get().getDefaultState()), ImmutableList.of(Blocks.WATER.getDefaultState()), ImmutableList.of(Blocks.WATER.getDefaultState())))).func_242733_d(32).func_242728_a().func_242731_b(100);

        register("double_deepturf_patch", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(UGBlocks.double_deepturf.get().getDefaultState()), new DoublePlantBlockPlacer())).tries(32).whitelist(ImmutableSet.of(UGBlocks.deepturf_block.get())).func_227317_b_().build()).func_242733_d(256).func_242728_a().func_242731_b(100));
        register("double_shimmerweed_patch", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(UGBlocks.double_shimmerweed.get().getDefaultState()), new DoublePlantBlockPlacer())).tries(16).whitelist(ImmutableSet.of(UGBlocks.deepturf_block.get())).func_227317_b_().build()).func_242733_d(256).func_242728_a().func_242731_b(50));
        ...
        register("underbean_patch", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(UGBlocks.underbean_bush.get().getDefaultState().with(BeanBushBlock.AGE, 3)), new SimpleBlockPlacer())).tries(64).whitelist(ImmutableSet.of(UGBlocks.deepturf_block.get())).func_227317_b_().build()).func_242733_d(256).func_242728_a().func_242731_b(5));
        register("blisterberry_patch", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(UGBlocks.blisterberry_bush.get().getDefaultState().with(BlisterberryBushBlock.AGE, 3)), new SimpleBlockPlacer())).tries(64).whitelist(ImmutableSet.of(UGBlocks.ashen_deepturf.get())).func_227317_b_().build()).func_242733_d(256).func_242728_a().func_242731_b(5));
