...
public class UGPlacedFeatures {
	...
	public static ResourceKey<PlacedFeature> create(String name) {
		return ResourceKey.create(Registries.PLACED_FEATURE, Undergarden.prefix(name));
	}
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		context.register(DITCHBULB_PATCH, new PlacedFeature(features.getOrThrow(UGConfiguredFeatures.DITCHBULB), patchWithFilter(25, 16, BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), UGBlocks.DEPTHROCK.get(), UGBlocks.DREADROCK.get()))));
