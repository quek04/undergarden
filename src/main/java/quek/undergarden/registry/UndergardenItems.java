...
public class UndergardenItems {
    ...
    public static final RegistryObject<Item> droopvine_item = ITEMS.register("droopvine_item", () -> new BlockItem(UndergardenBlocks.droopvine_top.get(), (new Item.Properties()).group(UndergardenItemGroups.GROUP)));
    ...
    public static final RegistryObject<AxeItem> smogstem_axe = ITEMS.register("smogstem_axe", () -> new UndergardenAxeItem(UndergardenItemTiers.SMOGSTEM, 6));
    ...
    public static final RegistryObject<AxeItem> cloggrum_axe = ITEMS.register("cloggrum_axe", () -> new UndergardenAxeItem(UndergardenItemTiers.CLOGGRUM, 3));
    ...
    public static final RegistryObject<AxeItem> froststeel_axe = ITEMS.register("froststeel_axe", () -> new UndergardenAxeItem(UndergardenItemTiers.FROSTSTEEL, 4));
    ...
    public static final RegistryObject<AxeItem> utheric_axe = ITEMS.register("utheric_axe", () -> new UndergardenAxeItem(UndergardenItemTiers.UTHERIC, 3.5F));
    ...
    public static final RegistryObject<Item> rotdweller_spawn_egg = ITEMS.register("rotdweller_spawn_egg", () -> new UndergardenSpawnEggItem(UndergardenEntities.rotdweller, 4804417, 16776960));
    ...
    public static final RegistryObject<Item> rotbeast_spawn_egg = ITEMS.register("rotbeast_spawn_egg", () -> new UndergardenSpawnEggItem(UndergardenEntities.rotbeast, 5988164,10963256));
