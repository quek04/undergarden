...
public class UGBlocks {
	...
	public static final DeferredBlock<Block> GRONGLE_LEAVES = registerWithItem("grongle_leaves", (properties) -> new TintedParticleLeavesBlock(0.01F, properties), () -> BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).sound(SoundType.AZALEA_LEAVES));
