...
public class UGBlocks {
    ...
    public static final RegistryObject<CarpetBlock> MOGMOSS_RUG = register("mogmoss_rug", () -> new CarpetBlock(DyeColor.LIME, AbstractBlock.Properties.copy(Blocks.WHITE_CARPET)));
