...
public class UGBlocks {
	...
	//dreadrock
	public static final DeferredBlock<Block> DREADROCK = registerWithItem("dreadrock", Block::new, () -> BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).mapColor(MapColor.TERRACOTTA_GREEN).strength(3.0F, 12.0F).sound(UGSoundTypes.DREADROCK).requiresCorrectToolForDrops());
	public static final DeferredBlock<Block> DREADROCK_BRICKS = registerWithItem("dreadrock_bricks", Block::new, () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK.get()));

	public static final DeferredBlock<StairBlock> DREADROCK_STAIRS = registerWithItem("dreadrock_stairs", properties -> new StairBlock(DREADROCK.get().defaultBlockState(), properties), () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK.get()));
	public static final DeferredBlock<StairBlock> DREADROCK_BRICK_STAIRS = registerWithItem("dreadrock_brick_stairs", properties -> new StairBlock(DREADROCK_BRICKS.get().defaultBlockState(), properties), () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK_BRICKS.get()));

	public static final DeferredBlock<SlabBlock> DREADROCK_SLAB = registerWithItem("dreadrock_slab", SlabBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK.get()));
	public static final DeferredBlock<SlabBlock> DREADROCK_BRICK_SLAB = registerWithItem("dreadrock_brick_slab", SlabBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK_BRICKS.get()));

	public static final DeferredBlock<WallBlock> DREADROCK_WALL = registerWithItem("dreadrock_wall", WallBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK.get()));
	public static final DeferredBlock<WallBlock> DREADROCK_BRICK_WALL = registerWithItem("dreadrock_brick_wall", WallBlock::new, () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK_BRICKS.get()));
	...
	public static final DeferredBlock<Block> DREADROCK_UTHERIUM_ORE = registerWithItem("dreadrock_utherium_ore", properties -> new DropExperienceBlock(UniformInt.of(4, 8), properties), () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK.get()).strength(4.5F, 12.0F).requiresCorrectToolForDrops(), () -> new Item.Properties().rarity(UGItems.UTHERIUM_RARITY));
	public static final DeferredBlock<Block> DEPTHROCK_REGALIUM_ORE = registerWithItem("depthrock_regalium_ore", Block::new, () -> BlockBehaviour.Properties.ofFullCopy(DEPTHROCK.get()).strength(3.0F, 6.0F).requiresCorrectToolForDrops(), () -> new Item.Properties().rarity(Rarity.UNCOMMON));
	public static final DeferredBlock<Block> SHIVERSTONE_REGALIUM_ORE = registerWithItem("shiverstone_regalium_ore", Block::new, () -> BlockBehaviour.Properties.ofFullCopy(SHIVERSTONE.get()).strength(4.5F, 12.0F).requiresCorrectToolForDrops(), () -> new Item.Properties().rarity(Rarity.UNCOMMON));
	public static final DeferredBlock<Block> DREADROCK_ROGDORIUM_ORE = registerWithItem("dreadrock_rogdorium_ore", properties -> new DropExperienceBlock(UniformInt.of(4, 8), properties), () -> BlockBehaviour.Properties.ofFullCopy(DREADROCK.get()).strength(4.5F, 12.0F).requiresCorrectToolForDrops(), () -> new Item.Properties().rarity(UGItems.ROGDORIUM_RARITY));
