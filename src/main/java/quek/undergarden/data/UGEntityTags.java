...
public class UGEntityTags extends EntityTypeTagsProvider {
    ...
    protected void addTags() {
        ...
        //vanilla
        tag(EntityTypeTags.IMPACT_PROJECTILES).add(UGEntityTypes.BLISTERBOMB.get(), UGEntityTypes.ROTTEN_BLISTERBERRY.get(), UGEntityTypes.GOO_BALL.get(), UGEntityTypes.SLINGSHOT_PEBBLE.get(), UGEntityTypes.MINION_PROJECTILE.get());
    }
}