...
public class UGBiomeTags extends BiomeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Biomes.TICKS_UTHERIC_INFECTION).addTag(UGTags.Biomes.IS_DEPTHS_BIOME);
		...
		tag(UGTags.Biomes.HAS_DENIZEN_CAMP).add(UGBiomes.DEPTHS, UGBiomes.PUFF_MUSHROOM_FOREST);
