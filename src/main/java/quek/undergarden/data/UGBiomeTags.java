...
public class UGBiomeTags extends BiomeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		//undergarden
		tag(UGTags.Biomes.IS_UNDERGARDEN).add(UGBiomes.ANCIENT_SEA, UGBiomes.BARREN_ABYSS, UGBiomes.BLOOD_MUSHROOM_BOG, UGBiomes.DEAD_SEA, UGBiomes.DENSE_FOREST, UGBiomes.FORGOTTEN_FIELD, UGBiomes.FROSTFIELDS, UGBiomes.FROSTY_SMOGSTEM_FOREST, UGBiomes.GRONGLEGROWTH, UGBiomes.ICY_SEA, UGBiomes.INDIGO_MUSHROOM_BOG, UGBiomes.INK_MUSHROOM_BOG, UGBiomes.SMOGSTEM_FOREST, UGBiomes.SMOG_SPIRES, UGBiomes.VEIL_MUSHROOM_BOG, UGBiomes.WIGGLEWOOD_FOREST, UGBiomes.DEPTHS, UGBiomes.INFECTED_DEPTHS, UGBiomes.PUFF_MUSHROOM_FOREST);
		tag(UGTags.Biomes.IS_DEPTHS_BIOME).add(UGBiomes.DEPTHS, UGBiomes.INFECTED_DEPTHS, UGBiomes.PUFF_MUSHROOM_FOREST);
		tag(UGTags.Biomes.IS_OTHERSIDE).add(UGBiomes.HOWLING_PEAKS, UGBiomes.FIELDS_OF_SORROW);
		tag(UGTags.Biomes.TICKS_UTHERIC_INFECTION).addTag(UGTags.Biomes.IS_OTHERSIDE).addTag(UGTags.Biomes.IS_DEPTHS_BIOME);
		...
		tag(BiomeTags.WITHOUT_PATROL_SPAWNS).addTag(UGTags.Biomes.IS_UNDERGARDEN).addTag(UGTags.Biomes.IS_OTHERSIDE);
