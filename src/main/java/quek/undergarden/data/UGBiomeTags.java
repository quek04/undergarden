...
public class UGBiomeTags extends BiomeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Biomes.IS_OTHERSIDE).add(UGBiomes.HOWLING_PLAINS);
		tag(UGTags.Biomes.TICKS_UTHERIC_INFECTION).add(UGBiomes.DEPTHS, UGBiomes.INFECTED_DEPTHS, UGBiomes.PUFF_MUSHROOM_FOREST, UGBiomes.HOWLING_PLAINS);
