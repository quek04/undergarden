...
public class UGBiomeTags extends BiomeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Biomes.TICKS_UTHERIC_INFECTION).addTag(UGTags.Biomes.IS_OTHERSIDE).add(UGBiomes.DEPTHS, UGBiomes.INFECTED_DEPTHS, UGBiomes.PUFF_MUSHROOM_FOREST);
