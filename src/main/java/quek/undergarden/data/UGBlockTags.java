...
public class UGBlockTags extends IntrinsicHolderTagsProvider<Block> {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Blocks.SMOG_MOG_SPAWNABLE_ON).add(UGBlocks.ASHEN_DEEPTURF_BLOCK.get(), UGBlocks.COARSE_DEEPSOIL.get(), UGBlocks.DEPTHROCK.get(), UGBlocks.SHIVERSTONE.get());
