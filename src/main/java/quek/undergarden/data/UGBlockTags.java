...
public class UGBlockTags extends IntrinsicHolderTagsProvider<Block> {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Blocks.UNDERGARDEN_DEPTHS_CARVER_REPLACEABLES).addTag(UGTags.Blocks.DREADROCK_ORE_REPLACEABLES).addTag(BlockTags.DIRT).addTag(UGTags.Blocks.ORES_CLOGGRUM).addTag(UGTags.Blocks.ORES_FROSTSTEEL).addTag(UGTags.Blocks.ORES_UTHERIUM).addTag(UGTags.Blocks.ORES_REGALIUM).addTag(UGTags.Blocks.ORES_ROGDORIUM);
