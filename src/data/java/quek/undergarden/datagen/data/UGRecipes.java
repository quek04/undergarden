...
//		makeChiseledBricks(getter, UGBlocks.CHISELED_SEDIMENT_STONE, UGBlocks.SEDIMENT_STONE_SLAB).save(this.output);
...
//		depthrockStonecutting(UGBlocks.POLISHED_DEPTHROCK_WALL.get()).save(this.output, name("polished_depthrock_wall_stonecutting"));
		depthrockStonecutting(UGItems.DEPTHROCK_PEBBLE.get(), 9).save(this.output, name("depthrock_pebbles_from_depthrock_stonecutting"));
