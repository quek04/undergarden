...
public class UGBiomeTags extends BiomeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		//neoforge
		tag(Tags.Biomes.PRIMARY_WOOD_TYPE).addTag(UGTags.Biomes.PRIMARY_WOOD_TYPE_WIGGLEWOOD).addTag(UGTags.Biomes.PRIMARY_WOOD_TYPE_SMOGSTEM).addTag(UGTags.Biomes.PRIMARY_WOOD_TYPE_GRONGLE);
	}
}
