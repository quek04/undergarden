...
public abstract class UGBlockItemTags {
	...
	public void run() {
		...
		this.tag(BlockTags.SAPLINGS, ItemTags.SAPLINGS).add(UGBlocks.SMOGSTEM_SAPLING.get(), UGBlocks.WIGGLEWOOD_SAPLING.get(), UGBlocks.GRONGLE_SAPLING.get(), UGBlocks.DESICCATED_WHISPERWOOD_SAPLING.get());
		...
		this.tag(BlockTags.LEAVES, ItemTags.LEAVES).add(UGBlocks.SMOGSTEM_LEAVES.get(), UGBlocks.WIGGLEWOOD_LEAVES.get(), UGBlocks.GRONGLE_LEAVES.get(), UGBlocks.DESICCATED_WHISPERWOOD_LEAVES.get());
