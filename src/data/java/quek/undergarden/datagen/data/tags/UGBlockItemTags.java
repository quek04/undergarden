...
public abstract class UGBlockItemTags {
	...
	public void run() {
		...
		this.tag(Tags.Blocks.NATURAL_LOGS, Tags.Items.NATURAL_LOGS).add(UGBlocks.SMOGSTEM_LOG.get(), UGBlocks.WIGGLEWOOD_LOG.get(), UGBlocks.GRONGLE_LOG.get());
		this.tag(Tags.Blocks.NATURAL_WOODS, Tags.Items.NATURAL_WOODS).add(UGBlocks.SMOGSTEM_WOOD.get(), UGBlocks.WIGGLEWOOD_WOOD.get(), UGBlocks.GRONGLE_WOOD.get());
		this.tag(Tags.Blocks.STRIPPED_LOGS, Tags.Items.STRIPPED_LOGS).add(UGBlocks.STRIPPED_SMOGSTEM_LOG.get(), UGBlocks.STRIPPED_WIGGLEWOOD_LOG.get(), UGBlocks.STRIPPED_GRONGLE_LOG.get());
		this.tag(Tags.Blocks.STRIPPED_WOODS, Tags.Items.STRIPPED_WOODS).add(UGBlocks.STRIPPED_SMOGSTEM_WOOD.get(), UGBlocks.STRIPPED_WIGGLEWOOD_WOOD.get(), UGBlocks.STRIPPED_GRONGLE_WOOD.get());

		//vanilla
		this.tag(BlockTags.PLANKS, ItemTags.PLANKS).add(UGBlocks.WIGGLEWOOD_PLANKS.get(), UGBlocks.SMOGSTEM_PLANKS.get(), UGBlocks.GRONGLE_PLANKS.get(), UGBlocks.ANCIENT_ROOT_PLANKS.get());
		...
		this.tag(BlockTags.LEAVES, ItemTags.LEAVES).add(UGBlocks.SMOGSTEM_LEAVES.get(), UGBlocks.WIGGLEWOOD_LEAVES.get(), UGBlocks.GRONGLE_LEAVES.get());
