...
public class UGEntityTags extends EntityTypeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Entities.IMMUNE_TO_INFECTION).addTag(UGTags.Entities.ROTSPAWN).addTag(EntityTypeTags.UNDEAD).add(UGEntityTypes.DENIZEN.get(), UGEntityTypes.FORGOTTEN.get(), UGEntityTypes.FORGOTTEN_GUARDIAN.get(), UGEntityTypes.MINION.get(), UGEntityTypes.GREATER_DWELLER.get(), UGEntityTypes.MYSTERIOUS_POT.get(), UGEntityTypes.DWELLER.get());
