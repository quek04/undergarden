...
public class UGBlockTags extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Blocks.TREMBLECRUST_ORE_REPLACEABLES).add(UGBlocks.TREMBLECRUST.get(), UGBlocks.LOOSE_TREMBLECRUST.get(), UGBlocks.DESICCATED_WISPYGRASS_BLOCK.get());
		...
		tag(UGTags.Blocks.OTHERSIDE_CARVER_REPLACEABLES).addTag(UGTags.Blocks.BASE_STONE_OTHERSIDE).add(UGBlocks.DESICCATED_WISPYGRASS_BLOCK.get());
		...
		tag(UGTags.Blocks.SUPPORTS_WISPYGRASS).addTag(BlockTags.SUPPORTS_VEGETATION).add(UGBlocks.DESICCATED_WISPYGRASS_BLOCK.get());
		...
		tag(BlockTags.CAN_GLIDE_THROUGH).add(UGBlocks.DROOPVINE_PLANT.get(), UGBlocks.DROOPVINE.get(), UGBlocks.HANGING_GRONGLE_LEAVES.get(), UGBlocks.SEEPING_INK.get(), UGBlocks.HANGING_DESICCATED_WHISPERWOOD_LEAVES.get());
		...
		tag(BlockTags.MINEABLE_WITH_HOE).add(UGBlocks.HANGING_GRONGLE_LEAVES.get(), UGBlocks.HANGING_DESICCATED_WHISPERWOOD_LEAVES.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
			...
			UGBlocks.DESICCATED_WISPYGRASS_BLOCK.get()
		);
		...
		tag(BlockTags.SWORD_EFFICIENT).add(UGBlocks.SEEPING_INK.get(), UGBlocks.HANGING_GRONGLE_LEAVES.get(), UGBlocks.GLOOMGOURD.get(), UGBlocks.CARVED_GLOOMGOURD.get(), UGBlocks.GLOOM_O_LANTERN.get(), UGBlocks.SHARD_O_LANTERN.get(), UGBlocks.HANGING_DESICCATED_WHISPERWOOD_LEAVES.get());
		...
		tag(BlockTags.REPLACEABLE_BY_TREES).add(
			...
			UGBlocks.HANGING_DESICCATED_WHISPERWOOD_LEAVES.get());
