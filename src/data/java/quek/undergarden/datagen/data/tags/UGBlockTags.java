...
public class UGBlockTags extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(UGTags.Blocks.UNDERGARDEN_CARVER_REPLACEABLES).addTag(UGTags.Blocks.DEPTHROCK_ORE_REPLACEABLES).addTag(UGTags.Blocks.SHIVERSTONE_ORE_REPLACEABLES).addTag(UGTags.Blocks.DREADROCK_ORE_REPLACEABLES).addTag(BlockTags.DIRT).addTag(UGTags.Blocks.ORES_CLOGGRUM).addTag(UGTags.Blocks.ORES_FROSTSTEEL).addTag(UGTags.Blocks.ORES_UTHERIUM).addTag(UGTags.Blocks.ORES_REGALIUM).add(UGBlocks.SEDIMENT.get()).add(Blocks.POWDER_SNOW);
		tag(UGTags.Blocks.PORTAL_FRAME_BLOCKS).add(Blocks.STONE_BRICKS, Blocks.MOSSY_STONE_BRICKS, Blocks.CRACKED_STONE_BRICKS, Blocks.CHISELED_STONE_BRICKS, Blocks.DEEPSLATE_BRICKS, Blocks.CRACKED_DEEPSLATE_BRICKS, Blocks.DEEPSLATE_TILES, Blocks.CRACKED_DEEPSLATE_TILES, Blocks.POLISHED_DEEPSLATE, Blocks.REINFORCED_DEEPSLATE, UGBlocks.DEPTHROCK_BRICKS.get(), UGBlocks.DEPTHROCK_TILES.get(), UGBlocks.POLISHED_DEPTHROCK.get(), UGBlocks.SHIVERSTONE_BRICKS.get(), UGBlocks.DREADROCK_BRICKS.get());
		...
		tag(Tags.Blocks.FLOWERS_TALL).add(UGBlocks.TALL_SHIMMERWEED.get());
		...
		tag(BlockTags.SUPPORTS_BAMBOO).add(UGBlocks.DEEPTURF_BLOCK.get(), UGBlocks.FROZEN_DEEPTURF_BLOCK.get(), UGBlocks.ASHEN_DEEPTURF_BLOCK.get(), UGBlocks.DEEPSOIL.get(), UGBlocks.COARSE_DEEPSOIL.get());
		...
		tag(BlockTags.CANNOT_REPLACE_BELOW_TREE_TRUNK).add(UGBlocks.DEEPSOIL.get());
